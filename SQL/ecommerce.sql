...
/*Consulta de dados*/
    ...
    /*Consultas com filtros*/
        SELECT * FROM tbl_cliente WHERE id_usuario = 1;
        SELECT * FROM tbl_pedido WHERE id_pedido = 1;
        SELECT * FROM tbl_produto WHERE id_produto = '10wa';
    
    /*Consultas com ordenação*/
        SELECT * FROM tbl_cliente ORDER BY nome_usuario;
        SELECT * FROM tbl_pedido ORDER BY vlr_total;
        SELECT * FROM tbl_produto ORDER BY nome;

    /*Consultas com agrupamento*/
        SELECT * FROM tbl_cliente GROUP BY nome_usuario;
        SELECT * FROM tbl_pedido GROUP BY vlr_total;
        SELECT * FROM tbl_produto GROUP BY nome;
    
    /*Consultas com junção*/
        SELECT * FROM tbl_cliente INNER JOIN tbl_pedido ON tbl_cliente.id_usuario = tbl_pedido.cliente;
        SELECT * FROM tbl_pedido INNER JOIN tbl_produto ON tbl_pedido.produto = tbl_produto.id_produto;
        SELECT * FROM tbl_cliente INNER JOIN tbl_produto ON tbl_cliente.id_usuario = tbl_produto.id_produto;
    
    /*Consultas com junção e agrupamento*/  
        SELECT * FROM tbl_cliente INNER JOIN tbl_pedido ON tbl_cliente.id_usuario = tbl_pedido.cliente GROUP BY nome_usuario;
        SELECT * FROM tbl_pedido INNER JOIN tbl_produto ON tbl_pedido.produto = tbl_produto.id_produto GROUP BY vlr_total;
        SELECT * FROM tbl_cliente INNER JOIN tbl_produto ON tbl_cliente.id_usuario = tbl_produto.id_produto GROUP BY nome;

    /*Consultas com junção e ordenação*/
        SELECT * FROM tbl_cliente INNER JOIN tbl_pedido ON tbl_cliente.id_usuario = tbl_pedido.cliente ORDER BY nome_usuario;
        SELECT * FROM tbl_pedido INNER JOIN tbl_produto ON tbl_pedido.produto = tbl_produto.id_produto ORDER BY vlr_total;
        SELECT * FROM tbl_cliente INNER JOIN tbl_produto ON tbl_cliente.id_usuario = tbl_produto.id_produto ORDER BY nome;

    /*Consultas com junção, agrupamento e ordenação*/
        SELECT * FROM tbl_cliente INNER JOIN tbl_pedido ON tbl_cliente.id_usuario = tbl_pedido.cliente GROUP BY nome_usuario ORDER BY nome_usuario;
        ...
        SELECT * FROM tbl_cliente INNER JOIN tbl_produto ON tbl_cliente.id_usuario = tbl_produto.id_produto GROUP BY nome ORDER BY nome;          